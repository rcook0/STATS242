...
def write_report_html(out_dir: str, title: str, md_text: str, css: str = "") -> str:
    ...
    default_css = """
    body { font-family: system-ui, -apple-system, Segoe UI, Roboto, Helvetica, Arial, sans-serif; line-height: 1.5; margin: 32px; max-width: 980px; }
    h1,h2,h3 { line-height: 1.2; }
    code, pre { font-family: ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, monospace; }
    pre { padding: 12px; background: #f6f8fa; overflow-x: auto; border-radius: 8px; }

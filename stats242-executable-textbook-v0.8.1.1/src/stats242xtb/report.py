...
def write_report_html(out_dir: str, title: str, md_text: str, css: str = "", mathjax: bool = False, extra_head: str = "") -> str:
    ensure_dir(out_dir)
    try:
...
def write_report(out_dir: str, title: str, sections: List[Tuple[str, str]], *, mathjax: bool = False) -> tuple[str, str]:
    md_path = write_report_md(out_dir, title, sections)
    with open(md_path, "r", encoding="utf-8") as f:
        md_text = f.read()
    html_path = write_report_html(out_dir, title, md_text, mathjax=mathjax)
